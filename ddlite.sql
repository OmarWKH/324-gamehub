...
(
  ...
  CONSTRAINT CREATES FOREIGN KEY (CREATOR_ID) REFERENCES USERS (USER_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
  ...
  CONSTRAINT FILES FOREIGN KEY (REPORTER_ID) REFERENCES USERS (USER_ID) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT SUBJECT_OF FOREIGN KEY (REPORTED_ID) REFERENCES USERS (USER_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
  ...
  CONSTRAINT WRITES_B FOREIGN KEY (USER_ID) REFERENCES USERS (USER_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
  ...
  CONSTRAINT WRITES FOREIGN KEY (COMMENTOR_ID) REFERENCES USERS (USER_ID) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT BELONGS_B FOREIGN KEY (POST_ID, GROUP_ID, POST_WRITER_ID) REFERENCES BLOGPOST (POST_ID, GROUP_ID, USER_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
  ...
  CONSTRAINT WRITES_CM FOREIGN KEY (USER_ID) REFERENCES USERS (USER_ID) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT BELONGS_CC FOREIGN KEY (CC_Name, GROUP_ID) REFERENCES CHAT_CHANNEL (CC_Name, GROUP_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
  ...
  CONSTRAINT BELONGS_G2 FOREIGN KEY (GROUP_ID) REFERENCES GROUPS (GROUP_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
  ...
  CONSTRAINT UL FOREIGN KEY (USER_ID) REFERENCES USERS (USER_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
  ...
  OS TEXT NOT NULL,
  GAME_ID INTEGER NOT NULL,
  CONSTRAINT WORKS_ON FOREIGN KEY (GAME_ID) REFERENCES VIDEO_GAME (GAME_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
  ...
  GROUP_ID INTEGER NOT NULL,
  USER_ID INTEGER NOT NULL,
  CONSTRAINT CONTAINS FOREIGN KEY (POST_ID, GROUP_ID, USER_ID) REFERENCES BLOGPOST (POST_ID, GROUP_ID, USER_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
  ...
  USER_ID INTEGER NOT NULL,
  GROUP_ID INTEGER NOT NULL,
  CONSTRAINT MEMBER_OF FOREIGN KEY (USER_ID) REFERENCES USERS (USER_ID) ON DELETE CASCADE ON UPDATE CASCADE,
